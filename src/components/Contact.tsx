  ...
  return (
    <section id="contact" className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-2 fade-in">Get In Touch</h2>
          ...
          <div className="md:col-span-1 fade-in">
            <div className="bg-card rounded-lg p-6 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <div className="bg-secondary p-3 rounded-full mr-4">
                    <Phone size={20} className="text-foreground/70" />
                  </div>
                  <div>
              ...
              <div className="mt-10">
                <h4 className="text-sm text-foreground/70 mb-3">Connect With Me</h4>
                <div className="flex space-x-4">
                  ...
                  <a 
                    href="https://github.com/MrMKsharma" 
                    className="bg-secondary hover:bg-secondary/80 p-3 rounded-full transition-colors"
                    aria-label="GitHub"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a 
                    href="https://www.instagram.com/mk_sharma_31/" 
                    className="bg-secondary hover:bg-secondary/80 p-3 rounded-full transition-colors"
