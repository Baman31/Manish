  ...
  const achievements = [
    {
      ...
      description:
        "Selected as Microsoft Learn Student Ambassador, mentoring students in cloud technologies",
      icon: Trophy,
      color: "text-blue-500",
    ...
    },
    {
      ...
      description:
        "Won first place in national level hackathon for innovative cloud solution",
      icon: Trophy,
    ...
    },
    {
      ...
      description:
        "Active contributor to popular DevOps and cloud infrastructure projects",
      icon: Star,
  ...
  return (
    <section id="certifications" className="py-20 bg-secondary/50">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-semibold mb-6 fade-in">
            Certifications
          </h3>
